...
app.use(session({
    ...
    cookie: { httpOnly: true, maxAge: 60000, path: '/admin' }, //!!настройка cookie, в частности время жизни 1 мин
    resave: false, //!!на всякий случай, используется для хранилищ без функции touch
